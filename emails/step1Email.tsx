...
interface Step1EmailProps {
    ...
    withPrint: string;
    howDoYouSend: string;
    whatDoYouSend: string;
}

export const Step1Email = ({
    quality = "Example", color = "Example", withPrint = "Example", howDoYouSend = "Example", whatDoYouSend = ""
}: Step1EmailProps) => {

    const text = `A new Step 1 Submission`;
                ...
                <Body className="bg-[#fff] my-auto mx-auto font-sans">
                    ...
                    >
                        ...
                        <Text className="text-[#121212]">
                            ...
                            Qualität: {quality}
                            <br />
                            Bedruckung: {withPrint}
                            <br />
                            Wie wird versandt: {howDoYouSend}
                            <br />
                            Was wird versand (optional): {whatDoYouSend}
                            <br />
                            <br />
                            <br />
                            That's it.
