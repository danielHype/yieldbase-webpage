      ...
      <div className="max-w-[600px] m-auto my-20">
        ...
        <div className="text-component line-height-lg v-space-md">
          ...
          <p className="leading-7 mt-8">
            ...
            your relationship with YieldBase application (the "Service") operated
            by YieldBase Labs AB ("us", "we", or "our").
          </p>

          <p className="leading-7 mt-8">
            Please read these Terms and Conditions carefully before using our
            YieldBase application (the "Service").
          </p>
          ...
          <p className="leading-7 mt-8">
            ...
            cancel it or YieldBase Labs AB cancels it. You may cancel your
            Subscription renewal either through your online account management
            page or by contacting YieldBase Labs AB customer support team.
          </p>
          ...
          <p className="leading-7 mt-8">
            ...
            you automatically authorize YieldBase Labs AB to charge all
            Subscription fees incurred through your account to any such payment
            instruments.
          </p>

          <p className="leading-7 mt-8">
            Should automatic billing fail to occur for any reason, YieldBase Labs
          ...
          <p className="leading-7 mt-8">
            YieldBase Labs AB, in its sole discretion and at any time, may modify
          ...
          <p className="leading-7 mt-8">
            YieldBase Labs AB will provide you with a reasonable prior notice of
          ...
          <p className="leading-7 mt-8">
            ...
            "Copyright Infringement" of dmca@yieldbase.ai and include in your
          ...
          <p className="leading-7 mt-8">
            ...
            property of YieldBase Labs AB and its licensors. The Service is
            ...
            written consent of YieldBase Labs AB.
          </p>
          ...
          <p className="leading-7 mt-8">
            ...
            that are not owned or controlled by YieldBase Labs AB.
          </p>

          <p className="leading-7 mt-8">
            YieldBase Labs AB has no control over, and assumes no responsibility
          ...
          <p className="leading-7 mt-8">
            In no event shall YieldBase Labs AB, nor its directors, employees,
          ...
          <p className="leading-7 mt-8">
            YieldBase Labs AB its subsidiaries, affiliates, and its licensors do
